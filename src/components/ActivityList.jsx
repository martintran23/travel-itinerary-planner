...
function ActivityList({ activities, onAddActivity, onDeleteActivity, onEditActivity, checkedIds, onToggleChecked }) {
    ...
    <section className="rounded-2xl bg-[#00274C] p-3 shadow-sm ring-1 ring-[#001C36]">
      <div className="rounded-xl bg-slate-100 p-4 sm:p-5">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <div className="lg:w-72 lg:shrink-0 lg:border-l lg:border-slate-200 lg:pl-6">
            <ActivityChecklist
